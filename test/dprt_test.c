/* dprt_test.c
** $Header: /space/home/eng/cjm/cvs/libdprt-grope/test/dprt_test.c,v 1.1 2005-11-29 16:01:35 cjm Exp $
*/
/**
 * dprt_test.c Tests libdprt_grope, the Data Pipeline Real Time
 ...
 */
static char rcsid[] = "$Id: dprt_test.c,v 1.1 2005-11-29 16:01:35 cjm Exp $";
/**
...
static void Help(void)
{
	fprintf(stdout,"dprt_test Tests the reduction routines in libdprt_grope.\n");
